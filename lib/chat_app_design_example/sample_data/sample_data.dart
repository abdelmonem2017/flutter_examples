...
final User currentUser =
    new User(id: 0, name: 'Abdelmeonem', imageURL: "user0.jpg");

final User sam = new User(id: 0, name: 'Sam', imageURL: "user1.jpg");

final User ben = new User(id: 0, name: 'ben', imageURL: "user2.jpg");

final User john = new User(id: 0, name: 'john', imageURL: "user3.jpg");

final User oblivia = new User(id: 0, name: 'oblivia', imageURL: "user4.jpg");

final User midhat = new User(id: 0, name: 'midhat', imageURL: "user5.jpg");
...
List<Message> chatMessages = [msg1, msg2, msg3, msg4, msg5, msg6, msg7, msg8 ];